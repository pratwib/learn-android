...
import com.pratwib.mynoteapps.R
import com.pratwib.mynoteapps.database.Note
import com.pratwib.mynoteapps.databinding.ActivityNoteAddUpdateBinding
import com.pratwib.mynoteapps.helper.DateHelper
import com.pratwib.mynoteapps.helper.ViewModelFactory
...
class NoteAddUpdateActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val actioBarTitle: String
        val btnTitle: String

        if (isEdit) {
            actioBarTitle = getString(R.string.change)
            ...
            actioBarTitle = getString(R.string.add)
            btnTitle = getString(R.string.save)
        }
        supportActionBar?.title = actioBarTitle
